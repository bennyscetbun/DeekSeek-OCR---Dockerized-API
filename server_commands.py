...
def process_image_endpoint(image_data: bytes, prompt: Optional[str] = Form(None)):
...
def process_pdf_endpoint(pdf_data: bytes, prompt: Optional[str] = Form(None), filename: str= "unknown"):
